...
// TODO: merge this with drowning marios (a transition between two tracks?)
// maybe if i can't find the memory address, i can just use the image on the screen
public class FlyingMarios : MonoBehaviour {
    [Serializable]
